...
public class JsonObjectProducer {
    ...
    private static Producer<String, JCompany> kafkaProducer;
    ...
    private static JCompany generateMessageForProducer()
    {
        var number = generateKeyForProducer(new Range(10, 50));
        return new JCompany(number, "haha" + number);
    }
    ...
    private static void sendRandomMessage(String topic) {
        ...
        ProducerRecord<String, JCompany> data = new ProducerRecord<>(topic, key, message);
