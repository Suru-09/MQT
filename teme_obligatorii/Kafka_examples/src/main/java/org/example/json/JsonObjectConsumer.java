...
public class JsonObjectConsumer {

    private static final Logger LOG = LoggerFactory.getLogger(JsonObjectConsumer.class);
    ...
    private static KafkaConsumer<String, JCompany> kafkaConsumer;
